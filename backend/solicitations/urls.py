...
urlpatterns = [
    ...
    path('<uuid:pk>/addendum/<uuid:addendum_pk>/submit/', views.solicitation_addendum_submit_view, name='solicitation-addendum-submit'),
    path('<uuid:pk>/addendum/<uuid:addendum_pk>/approve/', views.solicitation_addendum_approve_view, name='solicitation-addendum-approve'),
    path('<uuid:pk>/addendum/<uuid:addendum_pk>/reject/', views.solicitation_addendum_reject_view, name='solicitation-addendum-reject'),
    ...
    path('<uuid:pk>/generate-document/', views.solicitation_generate_document_view, name='sol-generate-document'),
    path('<uuid:pk>/download-document/', views.solicitation_download_document_view, name='sol-download-document'),
