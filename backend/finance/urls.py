...
urlpatterns = [
    ...
    path('delivery-advices/', views.DeliveryAdviceListView.as_view(), name='delivery-advice-list'),
    path('delivery-advices/<uuid:pk>/verify/', views.verify_delivery_advice_view, name='delivery-advice-verify'),
